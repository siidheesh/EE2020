...
#
# Generated by export_simulation on Fri Mar 31 15:49:40 +0800 2017
#
################################################################################
...
switch to the './blk_mem_gen_arb.sh' script.

./blk_mem_gen_arb.sh -reset_run
...
./blk_mem_gen_arb.sh -noclean_files

For more information on the script, please type './blk_mem_gen_arb.sh -help'.
