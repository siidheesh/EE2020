...
HD_PWD='C:/Users/sidxb/FPGA/ee2020/ee2020.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myDAC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myDAC.tcl -notrace
