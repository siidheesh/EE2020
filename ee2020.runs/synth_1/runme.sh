...
HD_PWD='C:/Users/sidxb/FPGA/ee2020/ee2020.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myDAC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myDAC.tcl
